...
export default function HotelMaysaPage() {
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            As infraestruturas de lazer oferecidas por Este hotel incluem uma sala fitness aberta 24 horas.
          </p>
          ...
          <div style={{
            ...
            <p style={{ margin: "5px 0", fontSize: "14px" }}>
              <strong>Endereço:</strong> Rua Teófilo Dias, 93 Caruaru
            </p>
            <p style={{ margin: "5px 0", fontSize: "14px" }}>
              <strong>Telefone:</strong> +55(81)21031900
            </p>
            <p style={{ margin: "5px 0", fontSize: "14px" }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {["Academia 24h", "Café da manhã", "Wi-Fi grátis", "Ar-condicionado", "Estacionamento"].map((comodidade, index) => (
