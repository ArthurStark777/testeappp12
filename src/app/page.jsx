...
export default function BentusRestaurantePage() {
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            É um espaço que combina sabor, autenticidade e aconchego, oferecendo uma experiência gastronômica marcante no cenário da cidade. Com um cardápio que valoriza ingredientes regionais e tradicionais.
          </p>
          ...
          <p style={{
            ...
            <strong>Endereço: R. Bogotá, 50 - Maurício de Nassau, Caruaru - PE</strong>
          </p>
